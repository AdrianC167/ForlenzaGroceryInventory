...
try:
    ...
    def remove_item():
        ...
        #changes is to in so no logical error would occur
        if name == inventory:
            ...
            print("Item not found in the inventory or typed incorrectly")
    ...
    while True:
        ...
        if choice == "1":
            ...
            print("Invalid choice. Please try again with an interger.")
except ValueError:
